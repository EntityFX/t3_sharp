...
[TestMethod][Timeout(5000)]public void PredicationTest(){var p=new T3InOrderProcessor<Word18>(T3Config.T3_18);p.PR=Word18.FromLong(531441);Ld(p,Word18.FromLong(InstructionEncoder.EncodeR(1,(int)Opcode.ADD,RW,RX,RY)),H());p.Registers[1]=Word18.FromLong(10);p.Registers[2]=Word18.FromLong(20);p.Run();Assert.AreEqual(30,p.Registers[0].ToLong());}
