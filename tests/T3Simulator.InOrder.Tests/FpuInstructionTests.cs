...
[TestMethod][Timeout(5000)]public void FSW_FLW_RoundTrip(){var p=P();Ld(p,I(Opcode.MOV,RW,42),RRg(-1,Opcode.ITF,FW,RW,0),I(Opcode.MOV,Rg1,100),RRg(-1,Opcode.ST,FW,Rg1,0),IRg(-1,Opcode.MOV,FW,0),RRg(-1,Opcode.LD,FW,Rg1,0),RRg(-1,Opcode.FTI,Rg2,FW,0),H());p.Run();Assert.AreEqual(42,p.Registers[6].ToLong());}
