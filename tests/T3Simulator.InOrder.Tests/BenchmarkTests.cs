...
namespace T3Simulator.InOrder.Tests
{
    ...
    public class BenchmarkTests
    {
        ...
        [TestMethod, Timeout(3000)] public void Predication() { var p = new T3InOrderProcessor<Word18>(T3Config.T3_18); p.PR = Word18.FromLong(1); p.Registers[1] = Word18.FromLong(10); p.Registers[2] = Word18.FromLong(20); Ld(p, Word18.FromLong(InstructionEncoder.EncodeR(1,0,0,(int)Opcode.ADD, RW, RX, RY)), H()); p.Run(); Assert.AreEqual(30, p.Registers[0].ToLong()); }
