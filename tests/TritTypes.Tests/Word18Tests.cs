...
namespace TritTypes.Tests
{
    ...
    public class Word18Tests
    {
        ...
        {
            long max = (Pow3(18) - 1) / 2;
            Word18 w = new Word18(max);
        ...
        {
            long min = -(Pow3(18) - 1) / 2;
            Word18 w = new Word18(min);
        ...
        {
            long max = (Pow3(18) - 1) / 2;
            try { new Word18(max + 1); Assert.Fail("Expected exception"); }
        ...
        {
            Word18 a = new Word18(1000);
            Word18 b = new Word18(2000);
        ...
        {
            Word18 a = new Word18(2000);
            Word18 b = new Word18(1000);
        ...
        {
            Word18 a = new Word18(100);
            Word18 b = new Word18(200);
        ...
        {
            Word18 a = new Word18(10);
            Word18 b = new Word18(3);
        ...
        {
            Word18 a = Word18.FromLong(0);
            Word18 b = Word18.FromLong(1);
            Word18 result = Word18.TritAnd(a, b);
            Assert.AreEqual(0, result.ToLong());
 
            a = Word18.FromLong(1);
            b = Word18.FromLong(1);
            result = Word18.TritAnd(a, b);
        ...
        public void TritOr_Works()
        {
            Word18 a = Word18.FromLong(0);
            Word18 b = Word18.FromLong(1);
            Word18 result = Word18.TritOr(a, b);
            Assert.AreEqual(1, result.ToLong());
        }
        ...
        {
            Word18 a = Word18.FromLong(1);
            Word18 b = Word18.FromLong(1);
            Word18 result = Word18.TritXor(a, b);
            Assert.AreEqual(-1, result.ToLong());
 
            a = Word18.FromLong(1);
            b = Word18.FromLong(-1);
            result = Word18.TritXor(a, b);
            Assert.AreEqual(0, result.ToLong());
        }
        ...
        public void Comparison_Works()
        {
            ...
            Assert.IsTrue(b >= a);
            Assert.IsTrue(a != b);
            Assert.IsTrue(a == new Word18(100));
        }

        [TestMethod]
        public void ToTritString_Zero_Returns18Zeros()
        {
            Word18 w = new Word18(0);
        ...
        public void Parse_RoundTrip_Works()
        {
            ...
            {
                Word18 w = new Word18(val);
                string s = w.ToTritString();
                Word18 parsed = Word18.Parse(s);
