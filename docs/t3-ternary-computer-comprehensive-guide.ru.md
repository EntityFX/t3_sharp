...
![Машинное слово / tint / tfloat — 18 тритов](images/word18.svg)
...
![Длинное слово / tlong long / tdouble — 54 трита](images/word54.svg)
...
![T3Float — 18 тритов с плавающей точкой](images/t3float.svg)
...
![T3Double — 36 тритов с плавающей точкой двойной точности](images/t3double.svg)
...
![TScii — Ternary Standard Code for Information Interchange](images/tscii.svg)
