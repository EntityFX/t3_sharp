...
*Примечание: текущий компилятор T-lang является исследовательским прототипом. Он реализует базовый синтаксис, поддержку структур, массивов и функций, но имеет ограниченную оптимизацию и не реализует все аспекты данной спецификации (например, некоторые спецификаторы типов и сложные правила преобразований).*
