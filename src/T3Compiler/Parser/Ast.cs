...
namespace T3Compiler.Parser
{
    ...
    {
        public int Value;
    } // trit: true=+1, false=-1, maybe=0

    public class NullLiteral : AstNode { }

    public class InitializerList : AstNode
    {
        public List<AstNode> Items = new();
    }
    ...
    public class AssignmentList : AstNode
    {
        public List<AstNode> Assignments = new();
    }
    ...
    public class ArrayAccess : AstNode
    {
        ...
        public List<AstNode> Indices = new();
    }
    ...
    public class IntrinsicCall : Statement
    {
        public string Name;
        public List<AstNode> Arguments = new();
    }
    ...
    public class FunctionDef
    {
        ...
        public string Name;
        public List<VarDeclaration> Parameters = new();
